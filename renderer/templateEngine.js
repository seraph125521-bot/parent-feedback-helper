(function (root, factory) {
  ...
  const AI_EXAMPLES_MAX = 800;
  const AI_AVOID_MAX = 300;
  ...
  function normalizeAiConfig(config) {
    ...
    return {
      enabled: true,
      examples: limitText(base.examples, AI_EXAMPLES_MAX),
      avoid: limitText(base.avoid, AI_AVOID_MAX),
    };
  }
  ...
  function normalizeConfig(config) {
    ...
    return { title, sections, aiConfig: normalizeAiConfig(base.aiConfig) };
  }
